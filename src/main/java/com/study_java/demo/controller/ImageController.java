...
import com.study_java.demo.service.image.IImageService;
import com.study_java.demo.service.image.ImageService;
    ...
    public ResponseEntity<ApiResponse> deleteImage(@PathVariable Long imageId) {
        try {
            ...
            if (image != null) {
                ...
                return ResponseEntity.ok(new ApiResponse("Delete successful", image));
            }
        } catch (ResourceNotFoundException e) {
